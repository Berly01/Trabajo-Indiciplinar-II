...
<body>
    ...
    <div id="page-content" class="page-content">
        ...
        <section id="why">
            <h2 class="title">¿Cómo afecta el cambio climático a Colombia?</h2>
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="card border-0 text-center gray-bg">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">
                                    La pérdida de glaciares en la cordillera de los Andes afecta el suministro de agua en algunas regiones, lo que puede llevar a escasez en el futuro.
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="card border-0 text-center gray-bg">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">
                                    Cambios en los patrones de lluvia y temperaturas pueden afectar la agricultura, reduciendo la productividad de ciertos cultivos y aumentando la aparición de plagas y enfermedades.
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="card border-0 text-center gray-bg">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">
                                    Colombia es uno de los países más ricos en biodiversidad del mundo. El cambio climático puede amenazar la diversidad biológica, poniendo en riesgo especies endémicas y ecosistemas únicos.
                            </div>
                        </div>
                    </div>
